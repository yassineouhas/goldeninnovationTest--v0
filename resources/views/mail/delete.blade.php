...
<body style="margin: 0; background-color: #d9dffa; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
    ...
    <p style="margin: 0; font-size: 14px;"><strong><span style="font-size:38px;">Notification</span></strong></p>
    </div>
    </div>
    </td>
    </tr>
    ...
    <p style="margin: 0; font-size: 14px;">You are receiving this email because a user deleted a Product.</p>
    </div>
    </div>
    </td>
    </tr>
    ...
    <div style="font-family: sans-serif">
    <div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
    <p style="margin: 0; font-size: 14px;"><span style="font-size:16px;">Product info:</span></p>
    <ul style="line-height: 1.2; mso-line-height-alt: 19.2px;">
